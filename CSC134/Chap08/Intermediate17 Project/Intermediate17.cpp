//Intermediate17.cpp - calculates the average number of text
//messages sent each day for 7 days, and the average number
//of text messages sent each week for 4 weeks
